;----------------------------------------------------------------------
pro sauron_colormap, REVERSE=rev
;
; The official SAURON colormap: type "sauron_colormap" to load the colormap.
;
; V1.0: Michele Cappellari & Eric Emsellem, Leiden, 10 July 2001
; V1.01: Added /REVERSE keyword. MC, Oxford, 9 August 2011
;
